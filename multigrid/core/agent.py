"""Definitions of the agents classes and their properties and behaviors."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01e_core.agent.ipynb.

# %% ../../nbs/01e_core.agent.ipynb #4c2dc1fb
...
from .actions import Action, NavigationAction
...
# %% auto #0
__all__ = ['front_pos', 'AgentState', 'Agent', 'NavigationAgent']

# %% ../../nbs/01e_core.agent.ipynb #0d7799f3
@functools.cache
...
# %% ../../nbs/01e_core.agent.ipynb #f744d9c7
...
# %% ../../nbs/01e_core.agent.ipynb #d1a63e18
class Agent:
    """
...
# %% ../../nbs/01e_core.agent.ipynb #e66fca19
class NavigationAgent(Agent):
    ...
    def __init__(
        ...
        # Actions are discrete integer values
        self.action_space = spaces.Discrete(len(NavigationAction))
