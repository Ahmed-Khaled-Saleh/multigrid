"""Definitions of the grid class, which represents the environment in which the agents and objects are placed. The grid is a 2D array of cells, each of which can contain an object or be empty. The grid also defines the rules for how agents can move and interact with objects."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01f_core.grid.ipynb.

# %% ../../nbs/01f_core.grid.ipynb #f5dbc17b
...
# %% ../../nbs/01f_core.grid.ipynb #a6fab5ab
@patch
...
# %% ../../nbs/01f_core.grid.ipynb #0ed77d03
@patch
...
# %% ../../nbs/01f_core.grid.ipynb #1ec0bf6c
@patch
...
# %% ../../nbs/01f_core.grid.ipynb #da1519a5
@patch
def horz_wall(
    self: Grid,
    x: int, y: int,
...
# %% ../../nbs/01f_core.grid.ipynb #32749d03
@patch
def render(
    self: Grid,
    tile_size: int,
