"""Definitions of all objects that can be placed in the environment, including their properties and behaviors."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01d_core.world_object.ipynb.

# %% ../../nbs/01d_core.world_object.ipynb #4ccd9d2e
...
# %% ../../nbs/01d_core.world_object.ipynb #beb70b24
...
# %% ../../nbs/01d_core.world_object.ipynb #72165812
...
# %% ../../nbs/01d_core.world_object.ipynb #91086ba3
class Lava(WorldObj):
    """
...
# %% ../../nbs/01d_core.world_object.ipynb #ce1f4c4b
class Wall(WorldObj):
    """
...
# %% ../../nbs/01d_core.world_object.ipynb #6f87085d
class Door(WorldObj):
    """
...
# %% ../../nbs/01d_core.world_object.ipynb #f6591c0f
class Key(WorldObj):
    """
...
# %% ../../nbs/01d_core.world_object.ipynb #36102b67
class Ball(WorldObj):
    """
...
# %% ../../nbs/01d_core.world_object.ipynb #fe20b3bd
class Box(WorldObj):
    """
