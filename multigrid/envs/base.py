"""The core logic of the multigrid environment."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02a_envs.base.ipynb.

# %% ../../nbs/02a_envs.base.ipynb #59a8c14b
...
# %% auto #0
__all__ = ['AgentID', 'ObsType', 'MultiGridEnv']

# %% ../../nbs/02a_envs.base.ipynb #e49d92ac
AgentID = int
ObsType = dict[str, Any]


# %% ../../nbs/02a_envs.base.ipynb #bf291dda
...
# %% ../../nbs/02a_envs.base.ipynb #4e730f4e
@patch
def step(
    self: MultiGridEnv,
...
# %% ../../nbs/02a_envs.base.ipynb #9fd3368b
@patch
def handle_actions(
...
# %% ../../nbs/02a_envs.base.ipynb #b3f765ab
@patch
def on_failure(
    self: MultiGridEnv,
    agent: Agent,
...
# %% ../../nbs/02a_envs.base.ipynb #c820da4e
@patch
def __str__(self: MultiGridEnv):
        """
...
# %% ../../nbs/02a_envs.base.ipynb #59627a39
@patch
def _reward(self: MultiGridEnv) -> float:
    """
...
# %% ../../nbs/02a_envs.base.ipynb #83fe992e
@patch
def put_obj(self: MultiGridEnv, obj: WorldObj, i: int, j: int):
    """
...
# %% ../../nbs/02a_envs.base.ipynb #3987d652
@patch
def place_agent(
    self: MultiGridEnv,
    agent: Agent,
...
# %% ../../nbs/02a_envs.base.ipynb #4a80f07c
@patch
def get_frame(
    self: MultiGridEnv,
    highlight: bool = True,
...
# %% ../../nbs/02a_envs.base.ipynb #2bef019b
@patch
def render(self: MultiGridEnv):
    """
