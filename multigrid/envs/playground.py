"""Environment with multiple rooms and random objects. This environment has no specific goals or rewards."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02g_envs.playground.ipynb.

# %% ../../nbs/02g_envs.playground.ipynb #cc32d015
...
# %% auto #0
__all__ = ['PlaygroundEnv']

# %% ../../nbs/02g_envs.playground.ipynb #9ea98b4c
...
@patch
def _gen_grid(self: PlaygroundEnv, width, height):
    """
    :meta private:
    """
