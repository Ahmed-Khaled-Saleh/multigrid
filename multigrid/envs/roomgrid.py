"""Base module for other room grid environments. Contains the Room and RoomGrid classes, which are used to create the grid and add doors between rooms."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02d_envs.roomgrid.ipynb.

# %% ../../nbs/02d_envs.roomgrid.ipynb #0d7aaf03
...
from ..core.world_object import Door, WorldObj
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #502e9891
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #75a28eeb
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #3e5235b5
class Room:
    """
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #01e3de31
@patch
def pos_inside(self: Room, x: int, y: int) -> bool:
    """
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #9edcb639
@patch
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #06a46a85
@patch
def _gen_grid(self: RoomGrid, width, height):
    # Create the grid
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #4984142b
@patch
def place_in_room(
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #80970ea3
@patch
def add_object(
    self: RoomGrid,
    col: int,
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #409ec9c0
@patch
def add_door(
    self: RoomGrid,
    col: int,
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #a1a09a84
@patch
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #18161c5d
@patch
def place_agent(
    self: RoomGrid,
    agent: Agent,
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #ac6a93ee
@patch
def connect_all(
    self: RoomGrid,
...
# %% ../../nbs/02d_envs.roomgrid.ipynb #6df86a82
@patch
def add_distractors(
    self: RoomGrid,
    col: int | None = None,
