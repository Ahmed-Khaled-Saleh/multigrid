...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00e_utils.obs.ipynb.
...
# %% ../../nbs/00e_utils.obs.ipynb #7e7595c0
import numba as nb
import numpy as np
...
# %% ../../nbs/00e_utils.obs.ipynb #ac20e034
...
# %% ../../nbs/00e_utils.obs.ipynb #c7f9a6f4
@nb.njit(cache=True)
...
# %% ../../nbs/00e_utils.obs.ipynb #0311d123
@nb.njit(cache=True)
def get_view_exts(
...
# %% ../../nbs/00e_utils.obs.ipynb #45834de2
@nb.njit(cache=True)
...
# %% ../../nbs/00e_utils.obs.ipynb #6697eff8
@nb.njit(cache=True)
...
# %% ../../nbs/00e_utils.obs.ipynb #acc7e74a
@nb.njit(cache=True)
def gen_obs_grid(
...
# %% ../../nbs/00e_utils.obs.ipynb #a22b310d
@nb.njit(cache=True)
...
# %% ../../nbs/00e_utils.obs.ipynb #0fa7b125
@nb.njit(cache=True)
def get_see_behind_mask(grid_array: ndarray[np.int_]) -> ndarray[np.int_]:
    """
    Return boolean mask indicating which grid locations can be seen through.
...
# %% ../../nbs/00e_utils.obs.ipynb #a50cc516
...
# %% ../../nbs/00e_utils.obs.ipynb #f9e0d92e
