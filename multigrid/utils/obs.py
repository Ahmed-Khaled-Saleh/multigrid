...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00d_utils.obs.ipynb.
...
# %% ../../nbs/00d_utils.obs.ipynb #51b170e3
from typing import Any


# %% ../../nbs/00d_utils.obs.ipynb #7e7595c0
import numba as nb
import numpy as np

from ..core.agent import AgentState, Agent
...
# %% ../../nbs/00d_utils.obs.ipynb #ac20e034
...
# %% ../../nbs/00d_utils.obs.ipynb #c7f9a6f4
@nb.njit(cache=True)
...
# %% ../../nbs/00d_utils.obs.ipynb #0311d123
@nb.njit(cache=True)
def get_view_exts(
...
# %% ../../nbs/00d_utils.obs.ipynb #45834de2
@nb.njit(cache=True)
...
# %% ../../nbs/00d_utils.obs.ipynb #6697eff8
@nb.njit(cache=True)
...
# %% ../../nbs/00d_utils.obs.ipynb #acc7e74a
@nb.njit(cache=True)
def gen_obs_grid(
...
# %% ../../nbs/00d_utils.obs.ipynb #a22b310d
@nb.njit(cache=True)
...
# %% ../../nbs/00d_utils.obs.ipynb #0fa7b125
@nb.njit(cache=True)
def get_see_behind_mask(grid_array: ndarray[np.int_]) -> ndarray[np.int_]:
    """
    Return boolean mask indicating which grid locations can be seen through.
...
# %% ../../nbs/00d_utils.obs.ipynb #a50cc516
def get_agent_obs_grid(
    grid: Grid,
    agent: Agent,
    agent_view_size: int,
    vis_mask: ndarray| None = None,
    ...
    if vis_mask is not None:
        for i in range(agent_view_size):
            for j in range(agent_view_size):
                if not vis_mask[i, j]:
                    obs_grid.set(i, j, None)


    return obs_grid


# %% ../../nbs/00d_utils.obs.ipynb #f9e0d92e
def gen_obs_grid_image(
    ...
    for agent_idx, agent in enumerate(agents):
        ...
        obs_grid = get_agent_obs_grid(grid, agent, agent_view_size, vis_mask=vis_mask[agent_idx])
